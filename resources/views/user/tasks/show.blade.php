...
<div class="max-w-4xl mx-auto bg-white p-6 rounded shadow-md">
    ...
    <div class="mb-6">
        ...
        <div class="mt-4 text-sm text-gray-600">
            ...
            <p><strong>Assigned By:</strong> {{ $task->assigned_by_admin->name ?? 'Unknown' }}</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.comments.store') }}">
        ...
        <div class="flex items-center space-x-4 mt-4">
            ...
            <a href="{{ route('tasks.index', $task->id) }}" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">Cancel</a>
        </div>
    </form>
</div>
@endsection
