    ...
    <div id="chat-messages" class="border border-gray-300 rounded-lg p-4 mb-5 h-72 overflow-y-scroll bg-white shadow-sm">
        @foreach ($messages as $message)
            ...
            <div class="mb-3 flex {{ $isUser ? 'justify-end' : 'justify-start' }}">
                <div class="max-w-xs px-4 py-2 rounded-lg {{ $isUser ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-900' }}">
...
<script>
    $(document).ready(function () {
        // const receiverType = "{{ class_basename(get_class(auth()->user())) }}";
        ...
        .listen('MessageSent', (e) => {
            ...
            const isUser = e.sender_id === senderId && e.sender_type === 'User';
